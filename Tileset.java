...
// added image filepath for tiles: AVATAR, WALL, FLOOR, SKULL, KEY
// all images are sourced from various open source websites
public class Tileset {
    public static final TETile AVATAR = new TETile('@', Color.white, Color.black, "you", "/images/avatar.png", 0);
    public static final TETile WALL = new TETile('#', new Color(216, 128, 128), Color.darkGray,
            "wall", "/images/stone_wall.png", 1);
    public static final TETile FLOOR = new TETile('·', new Color(128, 192, 128), Color.black, "floor", "/images/carpet.png", 2);
    ...
    public static final TETile SKULL = new TETile('☠', Color.white, Color.black, "king boo","/images/enemy.png", 13);
    public static final TETile HEART = new TETile('❤', Color.red, Color.black, "heart", 14);
    public static final TETile KEY = new TETile('k', Color.red, Color.black, "key", "/images/key.png", 15);
